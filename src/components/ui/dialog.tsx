    ...
    <DialogPortal>
      ...
      >
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "pointer-events-auto absolute left-[50%] top-[12%] z-50 grid w-full max-w-lg translate-x-[-50%] gap-4 border p-6 shadow-lg sm:rounded-lg pro-panel specular-edge duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
            className,
          )}
