...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:-translate-y-[1px] active:translate-y-0",
  {
    variants: {
      variant: {
        default: "text-foreground [background:linear-gradient(180deg,#1E293B,#0F172A)] [border:1px_solid_rgba(255,255,255,0.12)] [box-shadow:inset_0_1px_0_rgba(255,255,255,0.15),0_4px_16px_rgba(0,0,0,0.5)] hover:[background:linear-gradient(180deg,#263548,#162235)] hover:[box-shadow:inset_0_1px_0_rgba(255,255,255,0.18),0_4px_16px_rgba(0,0,0,0.5),0_0_16px_-3px_rgba(47,125,255,0.35)]",
