...
import {
  ScanLine, AlertTriangle, CheckCircle, Loader2, Volume2, Eye, Zap,
} from "lucide-react";
...
export default function ArtifactScannerPanel() {
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 cinema-inset space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-display text-sm font-bold">Technical QC</h3>
